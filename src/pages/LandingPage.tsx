  ...
  return (
    <main>
      ...
      <div className="relative bg-black text-white overflow-hidden pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-6xl font-bold mb-6 text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)] [text-shadow:_2px_2px_8px_rgb(0_0_0_/_80%)]">
            ...
            <div className="flex gap-4 justify-center">
              <Link to="/contact" className="bg-white text-purple-600 hover:bg-gray-100 px-8 py-4 rounded-xl font-bold transition-all shadow-2xl hover:shadow-white/50 transform hover:scale-105">
                Get Started
              </Link>
              <Link to="/about" className="bg-white/20 backdrop-blur-md hover:bg-white/30 text-white px-8 py-4 rounded-xl font-bold border-2 border-white/50 transition-all shadow-2xl">
                Learn More
              </Link>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Features Grid */}
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 -mt-20 mb-20 relative z-20">
          <FeatureCard
        ...
        {/* Stats Section */}
        <div className="bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 rounded-2xl shadow-xl p-12 mb-20 border border-purple-100">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="group hover:scale-105 transition-transform">
              <div className="text-5xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent mb-2">500+</div>
              <div className="text-gray-700 font-medium">Students Enrolled</div>
            </div>
            <div className="group hover:scale-105 transition-transform">
              <div className="text-5xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mb-2">50+</div>
              <div className="text-gray-700 font-medium">Expert Instructors</div>
            </div>
            <div className="group hover:scale-105 transition-transform">
              <div className="text-5xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-2">15+</div>
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 rounded-3xl p-16 text-center text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <Link 
              to="/contact" 
              className="inline-flex items-center gap-3 bg-white text-purple-600 px-10 py-4 rounded-xl font-bold hover:bg-blue-50 transition-all shadow-xl hover:shadow-2xl transform hover:scale-105"
            >
              Apply Now
